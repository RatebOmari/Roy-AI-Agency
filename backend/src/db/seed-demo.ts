...
async function seedDemo() {
  ...
  if (Number(mentionsExist[0].n) === 0) {
    ...
    await db.insert(listeningMentions).values([
      { userId: client1Id, platform: "instagram", keyword: "Raleigh Eats", username: "@foodie_riyadh", content: "Just tried @raleigheats for the first time and WOW 🤩 The shawarma is on another level. Definitely coming back!", sentiment: "positive", url: "https://instagram.com/p/demo1", handled: false, timestamp: new Date(Date.now() - 2 * 3_600_000) },
      { userId: client1Id, platform: "tiktok", keyword: "Raleigh Eats", username: "@riyadh_foodie_tv", content: "rating every restaurant in Riyadh — Raleigh Eats gets a 9/10 from me 🔥 the lamb machboos is 🤌", sentiment: "positive", url: "https://tiktok.com/@demo/video/1", handled: false, timestamp: new Date(Date.now() - 5 * 3_600_000) },
      { userId: client1Id, platform: "instagram", keyword: "raleigheats", username: "@disappointed_customer", content: "Waited 90 minutes for my delivery from Raleigh Eats tonight. No communication, food was cold. Very disappointed.", sentiment: "negative", handled: false, timestamp: new Date(Date.now() - 8 * 3_600_000) },
      { userId: client1Id, platform: "facebook", keyword: "Raleigh Eats", username: "Khalid Bin Saleh", content: "Question — does Raleigh Eats offer catering for weddings? Looking for something authentic for my sister's event.", sentiment: "neutral", handled: false, timestamp: new Date(Date.now() - 12 * 3_600_000) },
      { userId: client1Id, platform: "instagram", keyword: "raleigheats", username: "@mama_cooking_sa", content: "Finally found a restaurant that tastes like homemade 😭❤️ Raleigh Eats you are keeping our traditions alive. Thank you!", sentiment: "positive", url: "https://instagram.com/p/demo2", handled: true, timestamp: new Date(Date.now() - 18 * 3_600_000) },
      { userId: client1Id, platform: "tiktok", keyword: "Raleigh Eats", username: "@reviews_riyadh", content: "Raleigh Eats review: Great food, decent prices, but the parking situation needs improvement.", sentiment: "neutral", url: "https://tiktok.com/@demo/video/2", handled: false, timestamp: new Date(Date.now() - 24 * 3_600_000) },
    ]);
  ...
  if (Number(commentsExist[0].n) === 0) {
    ...
    await db.insert(comments).values([
      { userId: client1Id, platform: "instagram" as const, username: "@layla.h", text: "This looks amazing! What time do you open?", aiReply: "Thank you Layla! We open at 12pm daily. Can't wait to have you in 😊", status: "pending" as const, timestamp: new Date(Date.now() - 1 * 86_400_000) },
      { userId: client1Id, platform: "instagram" as const, username: "@ahmed.k", text: "Best shawarma in Riyadh no cap 🔥🔥🔥", aiReply: "Thank you Ahmed, that means a lot to us! See you soon 🌯", status: "approved" as const, timestamp: new Date(Date.now() - 1 * 86_400_000) },
      { userId: client1Id, platform: "tiktok" as const, username: "@riyadh_foodie_tv", text: "Do you deliver to north Riyadh?", aiReply: "Yes! We deliver all over Riyadh via Jahez and HungerStation. Drop us a DM to confirm your area 🙌", status: "pending" as const, timestamp: new Date(Date.now() - 2 * 86_400_000) },
      { userId: client1Id, platform: "instagram" as const, username: "@mama_cooking_sa", text: "The lamb machboos looks exactly like my grandma used to make 😭❤️", aiReply: "That's the highest compliment we could receive — we use traditional recipes passed down through generations. Thank you! ❤️", status: "auto_sent" as const, timestamp: new Date(Date.now() - 2 * 86_400_000) },
      { userId: client1Id, platform: "facebook" as const, username: "Sara Al-Otaibi", text: "Is the truffle hummus available for takeaway?", aiReply: "Absolutely, Sara! All our menu items are available for takeaway and delivery. Order through Jahez or DM us directly 😊", status: "approved" as const, timestamp: new Date(Date.now() - 3 * 86_400_000) },
      { userId: client1Id, platform: "instagram" as const, username: "@disappointed_user_22", text: "Waited 2 hours for delivery last week and the food was cold 😤", aiReply: "We're so sorry to hear about your experience. Please DM us your order details and we will make it right immediately.", status: "pending" as const, timestamp: new Date(Date.now() - 3 * 86_400_000) },
      { userId: client1Id, platform: "tiktok" as const, username: "@food_reviewer_ksa", text: "What's the price for the family meal?", aiReply: "Our Family Feast is 189 SAR for 4 people — includes main dish, rice, salad and drinks! Great value 😊", status: "pending" as const, timestamp: new Date(Date.now() - 4 * 86_400_000) },
    ]);
