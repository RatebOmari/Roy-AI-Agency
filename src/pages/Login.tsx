          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Mail className={`absolute top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground left-3`} />
                <input
                  type="email"
                  value={email}
                  ...
                  required
                  dir="ltr"
                  className={`w-full py-2.5 border border-border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary bg-background pl-10 pr-4`}
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Lock className={`absolute top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground left-3`} />
                <input
                  type="password"
                  value={password}
